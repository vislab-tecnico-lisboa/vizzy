...
void dslDatasetPanel::recording()
{
  ...
  command += " --duration=25 /datasetInfo /datasetStatus /vizzy/joint_states /tf /tf_static /vizzy/l_camera/camera_info /vizzy/l_camera/image_rect_color_throttled/compressed vizzy/r_camera/camera_info /vizzy/r_camera/image_rect_color_throttled/compressed /realsense/color/image_rect_color_throttled/compressed /realsense/depth_registered/points_throttled /vizzy/left_arm_cartesian_controll/cartesian_action/feedback /tactileForceField &";
