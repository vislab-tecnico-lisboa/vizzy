...
//  hat_finish_ = new QPushButton("Hat finish", this);
  ...
  letter_drop_ = new QPushButton("Letter drop", this);
  
  joint_inc_ = new QPushButton("Joint +", this);
  joint_dec_ = new QPushButton("Joint -", this);
...
//  gestures_layout->addWidget(hat_finish_);
  ...
  gestures_layout->addWidget(letter_drop_);
  gestures_layout->addWidget(joint_inc_);
  gestures_layout->addWidget(joint_dec_);
...
//  connect(hat_finish_, SIGNAL (released()), this, SLOT(hatFinish()));
  ...
  connect(letter_drop_, SIGNAL (released()), this, SLOT(letterDrop()));
  connect(joint_inc_, SIGNAL (released()), this, SLOT(jointIncrement()));
  connect(joint_dec_, SIGNAL (released()), this, SLOT(jointDecrement()));
...
void HINTT_Panel::letterDrop()
{
  command(10);
}
void HINTT_Panel::jointIncrement()
{
  command(11);
}
void HINTT_Panel::jointDecrement()
{
  command(12);
}
