...
T_inertial_endLeftArm = inv(Tp_0n_inertialSensor)*T_0n_leftArm;
[roll_left_arm,pitch_left_arm,yaw_left_arm] = dcm2angle(T_inertial_endLeftArm(1:3,1:3)','ZYX');
T_inertial_endRightArm = inv(Tp_0n_inertialSensor)*T_0n_rightArm;
[roll_right_arm,pitch_right_arm,yaw_right_arm] = dcm2angle(T_inertial_endRightArm(1:3,1:3)','ZYX');
