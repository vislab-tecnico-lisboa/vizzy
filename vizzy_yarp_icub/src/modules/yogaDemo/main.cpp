...
int main(int argc, char *argv[]) 
{
    ...
    icub.options[0].put("local", (prefix+"demo/torso/client").c_str()); //local port names
    icub.options[0].put("remote", (prefix+"torso").c_str());         //where we connect to
    icub.tags[0]="TORSO";

    icub.options[1].put("device", "remote_controlboard");
    icub.options[1].put("local", (prefix+"demo/head/client").c_str());   //local port names
    icub.options[1].put("remote", (prefix+"head").c_str());         //where we connect to
    icub.tags[1]="HEAD";

    icub.options[2].put("device", "remote_controlboard");
    icub.options[2].put("local", (prefix+"demo/right_shoulder_arm/client").c_str());   //local port names
    icub.options[2].put("remote", (prefix+"right_shoulder_arm").c_str());         //where we connect to
    icub.tags[2]="RIGHTARM";

    icub.options[3].put("device", "remote_controlboard");
    icub.options[3].put("local", (prefix+"demo/left_shoulder_arm/client").c_str());   //local port names
    icub.options[3].put("remote", (prefix+"left_shoulder_arm").c_str());         //where we connect to
    icub.tags[3]="LEFTARM";
    /*icub.options[3].put("device", "remote_controlboard");
	...
	fprintf(stderr, "vizzy demo --> Received a quit message\n");
    robot_mover->stop();
