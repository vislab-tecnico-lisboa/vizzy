...
protected:
	...
	VectorOf<int> modes(1);
        modes[0]=VOCAB_CM_POSITION;
...
public:
    ...
    bool threadInit()
    {
        ...
        Vector torsoSwitch(1);   torsoSwitch.zero();
        Matrix torsoLimits(1,4); torsoLimits.zero();
        ...
        homePoss.resize(8,0.0); homeVels.resize(8,0.0);
        ...
        openHandPoss.resize(3,0.0); closeHandPoss.resize(3,0.0);
        handVels.resize(3,0.0);
        ...
        optLeftArm.put("remote",(fwslash+robot+"/left_shoulder_arm").c_str());
        optLeftArm.put("local",(name+"/left_arm").c_str());

        optRightArm.put("remote",(fwslash+robot+"/right_shoulder_arm").c_str());
        ...
        //optCartLeftArm.put("remote","/server");
        //optCartLeftArm.put("local","/client");
        ...
        //optCartRightArm.put("remote","/server");
        //optCartRightArm.put("local","/client");
    ...
    void threadRelease()
    {
        ...
        checkTorsoHome(1.0);
        checkArmHome(LEFTARM,1.0);
        checkArmHome(RIGHTARM,1.0);
