...
class SlackROS():
    ...
    def __init__(self):
        ...
        pub = rospy.Publisher('/vizzy/slack/from_slack_to_ros', String, queue_size=10)
        rospy.Subscriber("/vizzy/slack/from_ros_to_slack", String, self.callback)
        rospy.Subscriber("/vizzy/slack/send_file_to_slack", String, self.filecallback)
...
if __name__ == '__main__':
    ...
    rospy.init_node('slack_ros',log_level=rospy.DEBUG)
